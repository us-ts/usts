...
//     this.logger.info(
//       "build",
//       `output: ${blue('"' + this.settings.config.output + '"')}`
//     );
//     this.logger.info(
//       "build",
//       `mode: ${blue('"' + this.settings.buildOutput + '"')}`
//     );
//     this.logger.info(
//       "build",
//       `directory: ${blue(fileURLToPath(this.settings.config.outDir))}`
//     );
...
//     this.logger.debug(
//       "build",
//       timerMessage("All pages loaded", this.timer.loadStart)
//     );
...
//       "build",
//       green(
//         `✓ Completed in ${getTimeStat(this.timer.init, performance.now())}.`
//       )
//     );
...
//     this.logger.debug(
//       "build",
//       timerMessage("Additional assets copied", this.timer.assetsStart)
//     );
